///////////////////////////////////////////////////////////////////////////////////
////
//// File: hbm.lazyload.js
//// Defines: 图片延迟加载
//// Dependencies: require.js, jquery.js
//// Description: 加载的图片显示加载中,加载失败，暂为图片
...
define(['jquery'],function($) {
    ...
    /**
    * 延迟加载图片
    * 要加载图片的地方调用此方法，将图片dom传入，便会自动有正在加载加载失败，暂无图片三种状态
    * @param {Object} img dom 参数
    */
